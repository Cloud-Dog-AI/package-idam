...
def test_banned_password_rejected() -> None:
    policy = PasswordPolicy(PasswordPolicyConfig(), banned_passwords={"password123!A"})
    result = policy.validate_password("password123!A", [], None)
