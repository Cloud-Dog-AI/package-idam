...
@dataclass(slots=True)
class ResourceType:
    """Represent a project-registered RBAC resource type."""
    resource_type: str
    label: str
...
class ResourceRegistry:
    """Represent the project resource registry consumed by PS-71 WebUI."""
    project: str
...
@dataclass(slots=True)
class RBACBinding:
    """Represent an explicit subject-resource-permission binding."""
